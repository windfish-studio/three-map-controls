...
module.exports = (function(THREE, _){
    ...
    THREE.MapControls = function ( object, domElement, options ) {
        ...
        function updateZoomAlpha(){
            ...
            zoomAlpha = Math.abs(Math.round((1 - ((currentZoom - scope.minDistance) / (scope.maxDistance - scope.minDistance))) * rounding_places ) / rounding_places);
        ...
        function updateDollyTrack(ray){
            ...
            if(intersect){
                ...
                targetZoom = currentZoom = intersect.clone().sub(scope.object.position).length();
            }
        }
